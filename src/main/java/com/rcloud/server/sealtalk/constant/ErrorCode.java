...
public enum ErrorCode {
    ...
    NOT_GROUP_MANAGER(400,"您不是群管理员.",400),
    ...
    MUTE_IM_SERVER_ERROR(501,"禁言失败，IM错误.",501),
    BLOCK_IM_SERVER_ERROR(502,"封禁用户失败，IM错误.",502),
    REMOVE_BLOCK_IM_SERVER_ERROR(503,"解封用户失败，IM错误.",503),
    NOT_GROUP_MEMBER_3(403,"Current user is not group member.",403),
    NOT_GROUP_MANAGER_3(403,"您不是管理员.",403),
    CAN_NOT_KICK_YOURSELF(400,"Can not kick yourself.",400),
    CAN_NOT_KICK_CREATOR(405,"不能将自己从群里移除.",405),
    CAN_NOT_MUTE_SELF(406,"不能禁言自己.",406),
    USER_HAVED_MUTE(407,"该用户已禁言.",406),
