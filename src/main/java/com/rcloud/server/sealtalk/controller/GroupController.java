...
public class GroupController extends BaseController {
    ...
    public APIResult<Object> create(@RequestBody GroupParam groupParam){
        try {
    ...
    public APIResult<Object> addMember(@RequestBody GroupParam groupParam){
        try {
    ...
    public APIResult joinGroup(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult kickMember(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            String[] memberIds = groupParam.getMemberIds();
    ...
    public APIResult<?> quitGroup(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            ValidateUtils.notEmpty(groupId);
    ...
    public APIResult dismiss(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult transfer(@RequestBody TransferGroupParam transferGroupParam){
        try {
    ...
    public APIResult batchSetManager(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            String[] memberIds = groupParam.getMemberIds();
            ValidateUtils.notEmpty(groupId);
    ...
    public APIResult batchRemoveManager(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            String[] memberIds = groupParam.getMemberIds();
    ...
    public APIResult rename(@RequestBody GroupParam groupParam){
        try {
            String name = groupParam.getName();
            String groupId = groupParam.getGroupId();
    ...
    public APIResult fav(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult deleteGroupFav(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            ValidateUtils.notEmpty(groupId);
    ...
    public APIResult setBulletin(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult setGroupPortraitUri(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            String portraitUri = groupParam.getPortraitUri();
            ...
            return APIResultWrap.ok(null,"群头像设置成功");
        }
        catch (ServiceException e) {
            return APIResultWrap.error(e);
        }
    ...
    public APIResult setDisplayName(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult<Object> setCertification(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult setMuteAll(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            ...
            return APIResultWrap.ok(null,"全员禁言成功");
        }
        catch (ServiceException e) {
            return APIResultWrap.error(e);
        }
    ...
    public APIResult setRegularClear(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult<?> getRegularClear(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            ValidateUtils.notEmpty(groupId);
    ...
    public APIResult setMemberInfo(@RequestBody GroupParam groupParam){
        try {
    ...
    public APIResult<?> getMemberInfo(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            String memberId = groupParam.getMemberId();
    ...
    public APIResult setMemberProtection(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
    ...
    public APIResult<GroupAddStatusDTO> copyGroup(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
            String name = groupParam.getName();
            String portraitUri = groupParam.getPortraitUri();
    ...
    public APIResult<GroupAddStatusDTO> agree(@RequestBody GroupParam groupParam){
        try {
            String groupId = groupParam.getGroupId();
